...
//               <Button variant="contained" color="primary" onClick={handleSignIn} id="join_btn">
//                     로그인
//               </Button>
...
//                 아직 회원이 아니신가요?<br/> 여기서 <Link to="/join">회원가입</Link>하세요!
//             </Typography>
//           </Grid>

//           <Grid item xs={7} id="lottie_div" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: 0}}>
      ...
      <Container id="join_con"  sx={{ marginTop: '70px', maxWidth: 1100, height: '70vh', padding: '0' }}>
        <Grid id='bbbb'container spacing={2} sx={{ height: '100%' }}>
          <Grid item xs={5} id="vvvv">
            ...
            <Typography id="if_you_have_id">
                아직 회원이 아니신가요? 여기서 <Link to="/join">회원가입</Link>하세요!
            </Typography>
          </Grid>
