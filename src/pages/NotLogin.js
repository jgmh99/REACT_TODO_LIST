        ...
        <Container id='wrap_how_to_use'>
          ...
          <Container id='sec_wirte'>
            ...
            <div className="write_txt">
              <div><p>3.Just login and enter Todolsit!</p></div>
              <div><p>4.You can also manage it with Completed, Incomplete, and All tabs.</p></div>
            </div>
          </Container>
